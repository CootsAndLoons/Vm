...
namespace Vm.Data.Migrations
{
    ...
    [Migration("20250413001216_PleasePleasePlease")]
    partial class PleasePleasePlease
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vm.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vm.Models.VacationRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Vm.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Vm.Models.ApplicationUser", b =>
                {
                    b.HasOne("Vm.Models.Role", "Role")
                        .WithMany("Users")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Vm.Models.Team", "Team")
                        .WithMany("Developers")
            ...
            modelBuilder.Entity("Vm.Models.Team", b =>
                {
                    ...
                    b.HasOne("Vm.Models.ApplicationUser", "TeamLead")
                        .WithMany()
